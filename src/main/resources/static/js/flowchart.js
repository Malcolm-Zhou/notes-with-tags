      ...
      \*********************************/
        ...
        function (module, exports, __webpack_require__) {
            function Symbol(chart, options, symbol) {
                ...
                var font = this.getAttr("font"), fontF = this.getAttr("font-family"),
            ...
            var drawAPI = __webpack_require__(/*! ./flowchart.functions */ 3), drawLine = drawAPI.drawLine,
                checkLineIntersection = drawAPI.checkLineIntersection;
            /* Gets the attribute based on Flowstate, Symbol-Name and default, first found wins */
            Symbol.prototype.getAttr = function (attName) {
                if (this.chart) {
                    var opt1, opt3 = this.chart.options ? this.chart.options[attName] : void 0,
                        opt2 = this.chart.options.symbols ? this.chart.options.symbols[this.symbolType][attName] : void 0;
                ...
                var line, x = this.getCenter().x, y = this.getCenter().y, right = this.getRight(),
                    bottom = this.getBottom(), top = this.getTop(), left = this.getLeft(),
                    symbolX = symbol.getCenter().x, symbolY = symbol.getCenter().y, symbolTop = symbol.getTop(),
                    symbolRight = symbol.getRight(), symbolLeft = symbol.getLeft(), isOnSameColumn = x === symbolX,
                    isOnSameLine = y === symbolY, isUnder = y < symbolY, isUpper = y > symbolY || this === symbol,
                    isLeft = x > symbolX, isRight = x < symbolX, maxX = 0, lineLength = this.getAttr("line-length"),
                ...
                if (//update line style
                    ...
                    for (var l = 0, llen = this.chart.lines.length; l < llen; l++) for (var len, otherLine = this.chart.lines[l], ePath = otherLine.attr("path"), lPath = line.attr("path"), iP = 0, lenP = ePath.length - 1; iP < lenP; iP++) {
                        ...
                        for (var line1_from_x = newPath[0][1], line1_from_y = newPath[0][2], line1_to_x = newPath[1][1], line1_to_y = newPath[1][2], lP = 0, lenlP = lPath.length - 1; lP < lenlP; lP++) {
                            ...
                            var line2_from_x = newLinePath[0][1], line2_from_y = newLinePath[0][2],
                                line2_to_x = newLinePath[1][1], line2_to_y = newLinePath[1][2],
                                res = checkLineIntersection(line1_from_x, line1_from_y, line1_to_x, line1_to_y, line2_from_x, line2_from_y, line2_to_x, line2_to_y);
      ...
      \************************************/
        ...
        function (module, exports) {
            function drawPath(chart, location, points) {
                ...
                var font = chart.options.font, fontF = chart.options["font-family"],
      ...
      \********************************/
        ...
        function (module, exports, __webpack_require__) {
            ...
            var FlowChart = __webpack_require__(/*! ./flowchart.chart */ 7),
                ...
                InputOutput = __webpack_require__(/*! ./flowchart.symbol.inputoutput */ 11),
                Subroutine = __webpack_require__(/*! ./flowchart.symbol.subroutine */ 14),
      ...
      \*******************************************/
        ...
        function (module, exports, __webpack_require__) {
            ...
            var Symbol = __webpack_require__(/*! ./flowchart.symbol */ 2),
                ...
                drawAPI = __webpack_require__(/*! ./flowchart.functions */ 3), drawPath = drawAPI.drawPath;
        ...
        function (module, exports, __webpack_require__) {
            function InputOutput(chart, options) {
                ...
                var width = this.text.getBBox().width + 4 * this.textMargin,
                    height = this.text.getBBox().height + 2 * this.textMargin, startX = this.textMargin,
                    startY = height / 2, start = {
                        x: startX,
                        y: startY
                    }, points = [{
